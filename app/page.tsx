...
const events: TimelineEvent[] = [
  ...
  },
  {
    ...
    source: "SRC-0065; SRC-0068; SRC-0071; SRC-0084; SRC-0010; SRC-0099, Trial Day 13, pp. 29–33 and 52–54; compare SRC-0032 ¶¶75–83", caution: "This combined card preserves each component's provenance. Do not treat family collateral, brief clinical/retail observations, phone artifacts, objective timestamps, attorney theories, and civil allegations as interchangeable evidence.", views: ["course"]
  },
  {
  ...
  },
  {
    ...
    details: ["Sergeant Daniel Lawler saw the clinician enter Clancy's hospital room but did not enter, listen, or know what was said.", "Lawler later learned that Clancy used the clinician's phone to call Patrick and recalled discussing the reported voice statement with lead investigator Joshua McKelligan.", "Before the jury, Lawler agreed that the prompting theory had no investigative basis and characterized it as McKelligan's speculation; he reiterated that he heard nothing in the room.", "The clinician visit was estimated only as two or three days after January 24, so this card's position is approximate."], source: "SRC-0098, Trial Day 12, voir dire 01:03:40–01:31:57; jury testimony 01:46:56–01:52:42", caution: "Do not state that a clinician planted, coached, or prompted the hallucination account. The witness established only that investigators discussed an unsupported theory.", views: ["post"]
  },
  {
...
const additionalCourseEvents: TimelineEvent[] = [
  {
    ...
    source: "SRC-0099, Trial Day 13, pp. 6–15, 00:59:17–01:28:40", caution: "State only what the device recorded. Do not attribute this browsing sequence to Lindsay or Patrick as established fact, and do not infer diagnosis or intent from the pages alone.", views: ["course"]
  },
  {
  ...
  },
  {
    ...
    medication: "Unnamed ‘new med’: reportedly started two nights earlier", source: "SRC-0099, Trial Day 13, p. 45, 03:30:44–03:31:19", caution: "Do not relabel this as confirmed amitriptyline use or add it to a named medication lane. The identity and dose remain unestablished.", views: ["course"]
  },
  {
  ...
  },
  {
    ...
    summary: "Tufts prescribed amitriptyline 10 mg and continued the diazepam taper; both medications were dispensed, but the public evidence conflicts or is unclear about the diazepam bottle's original quantity.", details: ["Amitriptyline 10 mg ×30 was filled; Exhibit 155 later contained 22 tablets. The eight-tablet difference is not proof that Clancy ingested them.", "The pharmacy display had been read as diazepam 2 mg ×3. In Exhibit 155 testimony, the January 16 bottle label appeared to show ‘three’ with a pink strike-through, while 9.5 tablets remained.", "The diazepam label and official inventory must be inspected before resolving the original quantity.", "Neither remaining nor missing tablets establish who handled them, when, the dose used, or adherence."], medication: "Elavil 10 mg; Valium 2 mg (original quantity unresolved)", source: "SRC-0091, 03:55:47–04:00:32; SRC-0048; SRC-0098, Trial Day 12, 00:51:05–00:51:49", caution: "Exhibit 155 documents a later bottle inventory, not administration. Missing tablets cannot be converted into doses taken.", views: ["course"]
  },
  {
