...
const events: TimelineEvent[] = [
  ...
  {
    id: "tufts-intake", date: "2022-09-15T10:00:00", displayDate: "September 15", title: "Clinical evaluation: first Tufts visit", short: "Anxiety, depression, insomnia, racing thoughts", category: "clinical", evidence: "Contemporaneous record", certainty: "High", clinician: "Jennifer Tufts, MD", institution: "Aster Mental Health", side: "top", tier: 1,
    ...
    details: ["Risky behavior, excessive energy, and impulsivity items were not checked.", "Sertraline 25 mg daily for one week, then 50 mg, and psychotherapy were prescribed.", "Sertraline 25 mg ×30 was filled the same day, but Clancy later said she had not begun taking it."], medication: "Sertraline 25 → 50 mg prescribed", source: "SRC-0087, Trial Day 9; SRC-0048 pharmacy exhibit", caution: "PRESCRIBED and FILLED do not establish that the medication was started that day.", views: ["course"]
  },
  {
    id: "sertraline-deferred", date: "2022-09-28T12:00:00", displayDate: "September 28", title: "MyChart message: sertraline not started", short: "Reports feeling better; medication paused", category: "medication", evidence: "Contemporaneous record", certainty: "High", clinician: "Jennifer Tufts, MD", institution: "Aster Mental Health", side: "bottom", tier: 1,
    summary: "Clancy reported that she had not started sertraline and felt improved. Tufts paused the plan and continued to recommend therapy.",
  ...
  {
    id: "sertraline-stop", date: "2022-10-20T12:00:00", displayDate: "October 20", title: "Clinical appointment: sertraline stopped", short: "Reports worse sleep, anxiety and fogginess", category: "medication", evidence: "Contemporaneous record", certainty: "High", clinician: "Jennifer Tufts, MD", institution: "Aster Mental Health", side: "bottom", tier: 0,
    summary: "After eventually starting sertraline and reportedly increasing from 25 to 50 mg, Clancy described worse sleep, anxiety, mental fog, and overnight racing thoughts. Tufts advised stopping it.",
    details: ["The exact start date and number of doses are unresolved.", "Later history to Jollotta described roughly 48 hours without sleep and without feeling tired; Jollotta called that an activating response."], medication: "Sertraline stopped; lorazepam introduced", source: "SRC-0087; SRC-0091; SRC-0096", caution: "Temporal association supports concern but does not prove a bipolar switch or medication causation.", views: ["course"]
  },
  {
    id: "oct21", date: "2022-10-21T12:00:00", displayDate: "October 21", title: "Clinical follow-up: acute insomnia and anxiety", short: "Scheduled next-day visit with Dr. Tufts", category: "symptom", evidence: "Contemporaneous record", certainty: "High", clinician: "Jennifer Tufts, MD", institution: "Aster Mental Health", side: "top", tier: 0,
  ...
  {
    id: "therapy", date: "2022-10-31T12:00:00", displayDate: "October 31", title: "Therapy visit", short: "SI and HI denied", category: "clinical", evidence: "Contemporaneous record", certainty: "Moderate", clinician: "Jennifer McAllister", institution: "Aster Mental Health", side: "top", tier: 2,
    summary: "A therapy note later read at trial stated that Clancy denied suicidal or homicidal ideation.",
    details: ["Tufts was not present for the encounter.", "The complete therapy chart is unavailable, and cross-examination questioned how extensively suicidality was assessed."], source: "SRC-0091, Trial Day 10, 03:05:25–03:10:45", caution: "High confidence for the note’s limited content; the unrecorded conversation cannot be reconstructed.", views: ["course"]
  },
  {
    id: "nov2", date: "2022-11-02T12:00:00", displayDate: "November 2", title: "Clinical follow-up: sleep improves", short: "Lorazepam taper discussed; buspirone not started", category: "clinical", evidence: "Contemporaneous record", certainty: "High", clinician: "Jennifer Tufts, MD", institution: "Aster Mental Health", side: "bottom", tier: 1,
    ...
    details: ["Lorazepam 0.5 mg ×40 was filled.", "Clancy said she had not started buspirone.", "Later testimony did not establish that the lorazepam taper was completed."], medication: "Lorazepam benefit; taper planned", source: "SRC-0087; SRC-0091; SRC-0048", views: ["course"]
  },
  {
    ...
    details: ["Trazodone 50 mg ×30 was filled.", "Clancy later told Paul it helped her fall asleep but did not maintain sleep."], medication: "Trazodone 50 mg", source: "SRC-0048; SRC-0065; SRC-0091", caution: "The encounter and fill are high confidence; exact sleep duration and medication effect are patient/collateral reports.", views: ["course"]
  },
  {
    id: "paul-intake", date: "2022-11-21T10:00:00", displayDate: "November 21", title: "Clinical intake: perinatal psychiatry", short: "Fluoxetine selected from prior reported benefit", category: "clinical", evidence: "Treating testimony", certainty: "High", clinician: "Julie Paul, psychiatric NP", institution: "South Shore Perinatal Behavioral Health", side: "bottom", tier: 0,
    ...
    details: ["The EPDS self-harm item was negative.", "She reported that Ativan plus Benadryl had helped sleep.", "Fluoxetine 10 mg ×56 was prescribed and filled based on historical benefit."], medication: "Fluoxetine 10 mg", source: "SRC-0091, Trial Day 10; SRC-0048", views: ["course"]
  },
  {
  ...
  {
    id: "dec16", date: "2022-12-16T15:00:00", displayDate: "December 16", title: "Phone/MyChart follow-up: mood not improved", short: "Sleep restored; lamotrigine reported from Tufts", category: "clinical", evidence: "Contemporaneous record", certainty: "High", clinician: "Jennifer Tufts, MD / Rebecca Jollotta, CNP", institution: "Aster / South Shore Perinatal Behavioral Health", side: "top", tier: 1,
    summary: "Clancy reported sleeping on quetiapine 200 mg plus diazepam 2 mg but experiencing no mood improvement.",
    details: ["Jollotta recommended quetiapine 300 mg as a bipolar-depression target.", "Tufts prescribed and the pharmacy filled lamotrigine 25 mg.", "Jollotta endorsed lamotrigine and provided rash/titration counseling but did not know whether Clancy took it."], medication: "Lamotrigine 25 mg prescribed/filled; quetiapine 300 mg recommended", source: "SRC-0096, pp. 63–70; SRC-0048", caution: "Endorsement and fill do not prove lamotrigine ingestion; a dose target does not establish diagnosis.", views: ["course"]
  },
  {
  ...
  {
    id: "discharge", date: "2023-01-05T15:00:00", displayDate: "January 5", title: "Inpatient discharge: McLean", short: "Trazodone + lorazepam + melatonin", category: "medication", evidence: "Contemporaneous record", certainty: "High", clinician: "Alia Goodheart, MD", institution: "McLean Hospital", side: "bottom", tier: 0,
    summary: "McLean discharged Clancy with short-term sleep/anxiety medication and no plan to continue quetiapine.",
    details: ["Trazodone 50 mg ×28 and lorazepam 1 mg ×14 were filled.", "Melatonin was included in the plan.", "Home adherence is not established by discharge prescriptions."], medication: "Trazodone 50 mg PRN; lorazepam 1 mg; melatonin", source: "SRC-0087; SRC-0048", views: ["course"]
  },
  {
    id: "jan6", date: "2023-01-06T12:00:00", displayDate: "January 6", title: "Clinical follow-up after McLean", short: "Full inpatient chart not available to Tufts", category: "clinical", evidence: "Contemporaneous record", certainty: "High", clinician: "Jennifer Tufts, MD", institution: "Aster Mental Health", side: "top", tier: 2,
  ...
  {
    id: "jan16", date: "2023-01-16T12:00:00", displayDate: "January 16", title: "Clinical visit: severe functional depression", short: "Amitriptyline begins", category: "clinical", evidence: "Contemporaneous record", certainty: "High", clinician: "Jennifer Tufts, MD", institution: "Aster Mental Health", side: "top", tier: 1,
    ...
    details: ["She denied SI, HI, and psychotic symptoms.", "Amitriptyline 10 mg ×30 was prescribed and filled.", "The diazepam taper continued; 2 mg ×3 was filled."], medication: "Amitriptyline 10 mg; diazepam taper", source: "SRC-0087; SRC-0091; SRC-0048", views: ["course"]
  },
  {
    id: "jan23", date: "2023-01-23T12:00:00", displayDate: "January 23", title: "Clinical visit: final pre-offense encounter", short: "Depressed, flat; sleep “okay”; SI/HI denied", category: "clinical", evidence: "Contemporaneous record", certainty: "High", clinician: "Jennifer Tufts, MD", institution: "Aster Mental Health", side: "bottom", tier: 1,
    ...
    details: ["She remained depressed, flat, and poorly motivated, although sleep was reportedly okay.", "Tufts slowed the diazepam taper and increased the prescribed amitriptyline dose to 20 mg.", "Clancy denied SI and HI, and Tufts observed no mania or psychosis."], medication: "Amitriptyline prescribed increase to 20 mg; diazepam 2 mg", source: "SRC-0087; SRC-0091; SRC-0048", caution: "Whether a 20-mg amitriptyline dose was actually taken is not established.", views: ["course"]
  },
  {
...
const additionalCourseEvents: TimelineEvent[] = [
  {
    id: "sep12-forms", date: "2022-09-12T12:00:00", displayDate: "September 12", title: "Clinical intake forms completed", short: "Pre-visit symptom and safety screening", category: "clinical", evidence: "Contemporaneous record", certainty: "High", clinician: "Jennifer Tufts, MD", institution: "Aster Mental Health", side: "bottom", tier: 0,
  ...
  {
    id: "tufts-dec1", date: "2022-12-01T16:00:00", displayDate: "December 1", title: "Clinical encounter: Tufts follow-up", short: "Fears approaching SI; lamotrigine discussed only", category: "clinical", evidence: "Treating testimony", certainty: "High", clinician: "Jennifer Tufts, MD", institution: "Aster Mental Health", side: "bottom", tier: 2,
    summary: "At a separate Tufts encounter, Clancy denied suicidal ideation but described fear of getting close to suicidal thoughts.", details: ["Lamotrigine was discussed but not prescribed that day.", "She reported having started mirtazapine and was uncertain whether quetiapine had begun."], medication: "Lamotrigine discussed—not prescribed", source: "SRC-0087, 06:22:22–06:24:03 and 06:28:36–06:28:59", caution: "Keep this clinician encounter distinct from the same-day portal exchange with Jollotta.", views: ["course"]
  },
  {
