...
type Evidence =
  ...
  | "Retrospective patient report"
  | "Record-review testimony"
  | "Secondary exhibit reporting"
  | "Civil allegation"
...
const commonQuestions = [
  ...
  },
  {
    ...
    answer: [
      "Not in the contemporaneous treating encounters presented at trial. Jollotta testified that the intrusive thoughts disclosed to her concerned wanting to die, not harming the children; the pre-offense Tufts testimony likewise did not establish disclosure of child-harm thoughts or a plan.",
  ...
  },
  {
    ...
    answer: [
      "Not in the treating evidence presented at trial. The pre-offense clinical encounters introduced at trial did not document a command hallucination, and Jollotta testified that Clancy did not describe hearing voices to her.",
  ...
  },
  {
    ...
    evidence: "Evidence basis: pharmacy exhibits and medication testimony summarized in the master corpus.",
  },
  {
    id: "expert-disagreement",
    question: "What do the retained psychiatric experts actually disagree about?",
    answer: [
      "The retained experts agreed that Clancy had a mental disease or defect on January 24, but disagreed about its diagnosis and legal effect. Defense experts Zeizel and Resnick described bipolar-spectrum illness and postpartum psychosis, interpreted the reported male voice and loss-of-agency account as psychotic, and concluded that both cognitive and volitional capacity were substantially impaired.",
      "Commonwealth expert Avram Mack diagnosed a major depressive episode, probably major depressive disorder, and found no mania or psychosis. Commonwealth experts Kirk Heilbrun and Gregory Saathoff accepted bipolar-II formulations but did not find offense-time psychosis. All three Commonwealth experts concluded that both legal capacities were retained. Their competing interpretations of retrospective accounts, organized conduct, dissociation, and symptom history are expert opinions—not established facts.",
    ],
    evidence: "Evidence basis: Zeizel testimony, Trial Days 15–16 (SRC-0105, SRC-0108); Resnick and Mack testimony, Trial Days 18–19 (SRC-0113, SRC-0118); Heilbrun and Saathoff testimony, Trial Days 19–21 (SRC-0118–SRC-0120).",
  },
  {
    id: "mistrial-meaning",
    question: "What did the mistrial decide?",
    answer: [
      "It produced no verdict. The jury did not acquit or convict Clancy and made no binding finding about psychosis or criminal responsibility. After seven days of deliberations, jurors reported that they could not reach a unanimous decision, and no verdict was recorded on any count. Judge William Sullivan declared a mistrial on September 4, 2026.",
      "The charges therefore remain pending, and whether the Commonwealth will retry the case was unresolved when this final update was prepared. Accounts of the jury's numerical split or the direction of individual votes were not established through a public jury poll and should not be treated as a verdict.",
    ],
    evidence: "Evidence basis: September 4 proceeding and mistrial declaration (SRC-0127); emergency SJC petition and denial (SRC-0128); contemporaneous final-day reporting (SRC-0131).",
  },
];
...
const events: TimelineEvent[] = [
  ...
  },
  {
    ...
    details: ["Risky behavior, excessive energy, and impulsivity items were not checked.", "Tufts's contemporaneous diagnoses were generalized anxiety disorder and adjustment disorder with depressed mood.", "Tufts recommended psychotherapy and discussed medication treatment.", "Prescription/fill: sertraline 25 mg daily for one week, then 50 mg planned; 25 mg ×30 filled."], source: "SRC-0087, Trial Day 9, pp. 66–98; SRC-0091, Trial Day 10, pp. 12–13 and p. 20, 01:11:21–01:11:47", caution: "The negative mental-status and safety findings apply to this video encounter, not every moment outside it.", views: ["course"]
  },
  {
  ...
  },
  {
    ...
    details: ["She described yawning without feeling drowsy.", "Patrick later recalled that, while trying to reduce sleep disruption, he slept in the basement for about two nights at her request and she then slept there for perhaps a couple of weeks. He knew continuing insomnia primarily from her reports rather than direct overnight observation.", "Tufts did not observe pressured speech, hyperactivity, mania, psychosis, suicidal ideation, homicidal ideation, or hallucinations.", "Prescription/fill: lorazepam 0.5 mg ×7 for short-term PRN treatment of severe anxiety."], source: "SRC-0087, Trial Day 9, pp. 107–109, 05:58:25–06:04:28; SRC-0091, Trial Day 10; SRC-0065, Trial Day 1, 01:46:08–01:47:24", caution: "‘Not drowsy’ is ambiguous within a broader picture of distressed insomnia. Patrick's collateral supports reported insomnia and sleep accommodations, not continuous observation of sleep.", views: ["course"]
  },
  {
  ...
  },
  {
    ...
    details: ["Patrick believed she had slept very little for approximately 48 hours.", "Susan Clancy testified that Lindsay drove herself to the emergency department and drove home. Susan met her there after about 90 minutes, sat with her, returned to work, and came back before discharge; she was present when the emergency physician prescribed trazodone.", "Lindsay reported insomnia, palpitations, anxiety, and sadness, and this was when Susan first learned the extent of the clinical concerns.", "Clancy later told Paul that the treatment prescribed after the visit helped her fall asleep but did not maintain sleep.", "Prescription/fill after the visit: trazodone 50 mg ×30."], source: "SRC-0065; SRC-0091; Exhibit 222 described on Trial Day 11; SRC-0105, Trial Day 15, 00:14:34–00:18:15", caution: "The encounter and trazodone fill are established; exact sleep duration, symptoms reported to Susan, and later treatment effect are patient/collateral reports rather than the complete ED chart.", views: ["course"]
  },
  {
    ...
    details: ["Her GAD-7 was 21/21 and EPDS was 23/30, with the EPDS self-harm item negative. Paul described the anxiety score as extreme and emphasized that screening instruments are not diagnoses.", "She reported that Ativan plus Benadryl had helped sleep.", "Paul's intake recorded one CBD gummy for sleep that did not help. A Women & Infants history later read in court described one marijuana edible followed by increased anxiety and palpitations; the public record does not establish whether these were the same episode.", "Prescription/fill: fluoxetine 10 mg ×56. Paul planned 10 mg for four days followed by 20 mg only if tolerated; the 20-mg step was not reached before fluoxetine was stopped."], source: "SRC-0091, Trial Day 10, pp. 84 and 96–99, 05:57:49–05:59:17 and 06:27:23–06:34:11", caution: "Screening scores are severity measures, not diagnoses. The planned 20-mg fluoxetine step does not establish that dose was taken. The edible/CBD histories may overlap and should not be silently merged or treated as a proven cause of the ED presentation.", views: ["course"]
  },
  {
  ...
  },
  {
    ...
    details: ["Paul remembered entering a progress note but could not firmly establish whether the discussion occurred by phone or MyChart.", "Clancy described logistical difficulty attending the program.", "Paul and Clancy also exchanged work-note messages; Clancy ultimately said she no longer qualified for short-term disability and would use personal leave.", "No psychosis was documented in the available exchange."], source: "SRC-0091, Trial Day 10, pp. 104–107, 06:47:55–06:53:39", caution: "The clinical content is supported; the communication medium is unresolved.", views: ["course"]
  },
  {
  ...
  },
  {
    ...
    details: ["Patrick described one or two nights of distressing internal thoughts involving harm or illness affecting the children. He said she supplied no method, plan, intent, or external voice and appeared disturbed by them.", "Musgrove independently recalled Clancy nervously telling both her and Patrick in early to mid-December that she had ‘thoughts of harming the children.’ Her testimony did not establish the exact content, frequency, images, urges, commands, intent, or plan.", "Patrick asked whether Clancy felt she could not be alone with the children; both witnesses recalled that she said no. Family came or remained present, and Musgrove recalled that Clancy was also afraid to be alone and slept in her bed around this period.", "Patrick recalled the week-after-Thanksgiving family visit as a period when Clancy spoke little, had low energy, and appeared ‘really depressed,’ while still eating, interacting to some degree, and sharing in care of the children. A planned December 3 anniversary outing was canceled because she felt unwell."],
    civilClaims: [{ claim: "The complaint further alleges thought-reading fears, fear of being locked up, and fear that the children would be taken.", source: "SRC-0032 ¶50", context: "The additional beliefs were not contemporaneously documented or corroborated in Musgrove's testimony. Opposing experts later discussed Clancy's retrospective account of asking her mother, ‘Can you hear my thoughts?’ Mack treated her acceptance of ‘no’ as reality testing; Zeizel interpreted the account as thought broadcasting." }],
    source: "SRC-0065, Trial Day 1, 02:00:26–02:02:52 and 02:06:24–02:11:58; SRC-0068, Trial Day 2, 01:46:52–01:47:49; SRC-0101, Trial Day 14, 02:09:34–02:10:50, 02:14:05–02:14:48, and 02:18:07–02:22:51; SRC-0108, Trial Day 16, 00:07:03–00:07:28 and 01:03:49–01:05:35; SRC-0113, Trial Day 18, 02:21:38–02:22:51; compare SRC-0032 ¶50", caution: "The testimony establishes a family disclosure but is insufficient to classify the thoughts retrospectively as OCD intrusions, homicidal intent, thought broadcasting, or psychosis.", views: ["course"]
  },
  {
  ...
  },
  {
    ...
    details: ["Clancy twice requested a phone call. Jollotta could not call between patients, so a nurse called around 3:10 p.m.; Clancy agreed to the plan and to collect quetiapine.", "Paul told Clancy on or around this date that Paul was leaving the clinic and believed transfer to Jollotta, who worked five days per week, was the best arrangement.", "Quetiapine 25 mg ×30 was filled.", "A fluoxetine retrial was discussed but not yet established as taken."], medication: "Quetiapine 25 mg prescribed/filled", source: "SRC-0096, pp. 27–31, approximately 01:41:00–01:46:41; SRC-0091, Trial Day 10, pp. 105–106, 06:51:14–06:51:49; SRC-0048", caution: "At 25 mg, the stated target was sleep; the fill does not establish ingestion.", views: ["course"]
  },
  {
  ...
  {
    id: "wi", date: "2022-12-20T12:00:00", displayDate: "December 20", title: "Program assessment: Women & Infants", short: "Evaluated but not accepted · alternatives reviewed", category: "hospital", evidence: "Record-review testimony", certainty: "Moderate", institution: "Women & Infants", side: "bottom", tier: 2,
    summary: "Clancy was evaluated but was not accepted into the specialized perinatal program. Later record-review testimony described her late symptom onset or lack of a clearly perinatal presentation as making that program an unsuitable fit.",
    details: ["Record-review testimony described three alternatives: inpatient hospitalization for medication management, a general mental-health PHP, or outpatient follow-up; Clancy said she would consult her provider.", "Jollotta was not opposed to tapering quetiapine but worried about loss of structured support, persistent intrusive thoughts, and starting a taper while she was away.", "Women & Infants material indicated an attempted call to Jollotta; she testified that she never received it."], civilClaims: [{ claim: "The complaint alleges EPDS 23 and GAD-7 21 scores, specific descriptions of profound depression/numbness, and a medication-induced formulation attributed to the Women & Infants clinician.", source: "SRC-0032 ¶¶52–57", context: "The pleading uses a December 21 date, while treating evidence places attendance on December 20. The complete Exhibit 220 is unavailable, so the pleaded formulation is not treated as the medical record." }], source: "SRC-0096; Exhibit 220 described on Days 10–11; SRC-0119/SRC-0133, Trial Day 20, 04:45:37–04:48:05; SRC-0120/SRC-0134, Trial Day 21, 03:03:07–03:03:43; compare SRC-0032 ¶¶52–57", caution: "The complete Women & Infants record is not publicly available. Program fit and offered alternatives entered through later expert review of the record rather than testimony from the evaluating clinician; the communication failure and pleaded clinical details remain unresolved.", views: ["course"]
  },
  {
  ...
  },
  {
    ...
    details: ["January 1, about 4 a.m.: Jasmine Outlaw evaluated her for voluntary admission, documented low risk with 15-minute checks, and provisionally formulated severe MDD without psychotic features.", "Later January 1 and January 2: Elizabeth Madva documented numbness or mild hospital anxiety, sleep at a lower quetiapine dose, and denials of delusions, hallucinations, SI, and HI.", "January 3: Goodheart found anxiety but linear, goal-directed thought and no psychosis. She considered bipolar/peripartum illness but had insufficient information for a firm diagnosis.", "McLean did not have immediate access to the South Shore or Aster charts, and Goodheart did not speak with Jollotta; the inpatient team relied on Clancy's history and Patrick's collateral.", "The chart described nursing and mental-health-worker contacts and participation in groups addressing illness and symptom management, self-compassion, medication management, and expressive therapy; it also recorded that she declined some groups and one CBT session.", "January 3 family texts said Clancy was all right but anxious about meeting the full psychiatry team and worried that she would not be sent home soon; the messages were patient-reported context rather than clinician observations.", "McLean tapered quetiapine approximately 75 → 50 → 25 → 0, switched diazepam to lorazepam, and used trazodone and melatonin for sleep. Cymbalta (duloxetine) was discussed only as a possible outpatient option after the taper and was not started at McLean.", "January 4: she reported hospital anxiety and asked to go home earlier than the Friday initially discussed. Goodheart conditioned January 5 discharge on arranging next-day psychiatry follow-up; Clancy did so within about an hour.", "In a January 4 message to her mother, Clancy said she had made a Friday appointment with ‘my other psychiatrist besides Rebecca.’ This contemporaneous phrasing supports overlapping care but does not establish what Tufts and Jollotta knew or exchanged."], civilClaims: [{ claim: "The complaint alleges that McLean operated with a ‘skeleton crew’ and that she did not see a doctor until January 3.", source: "SRC-0032 ¶¶61–63", context: "Sworn testimony described physician evaluations by Outlaw on January 1 and Madva on January 1–2, contradicting the pleaded ‘no doctor until January 3’ claim." }], medication: "Quetiapine tapered off; diazepam → lorazepam; trazodone/melatonin", source: "SRC-0087, Trial Day 9, pp. 20–41, 01:16:19–02:16:06; SRC-0099, Trial Day 13, pp. 42–43; SRC-0101, Trial Day 14, 02:22:55–02:24:16; compare SRC-0032 ¶¶61–63", caution: "Time-limited inpatient observations and family messages do not decide symptoms outside those moments; the complete McLean chart remains unavailable.", views: ["course"]
  },
  {
  ...
  },
  {
    ...
    sequence: [
      ...
      { time: "5:33–5:38 PM", title: "CVS callback and phone-recorded stair activity", detail: "Patrick testified that his first call went unanswered and Lindsay called back about a minute later; he recalled that she was ‘pretty quiet,’ sounded busy, understood his question about a generic substitute, and said yes. His thought that she was probably giving baths was an inference, not something he observed. The extraction recorded the outgoing callback as approximately 14 seconds and showed that it could be initiated from the lock screen. Phone-only data recognized completed flight climbs at about 5:33:34 and 5:38:33.", evidence: "Objective phone artifacts + Patrick sworn percipient/collateral testimony · SRC-0101, Trial Day 14, 00:18:47–00:27:21, 00:37:42–00:49:39; SRC-0068, 00:08:56–00:10:15" },
  ...
  },
  {
    ...
    details: ["Biswas found linear communication and no psychosis during a 20–30-minute assessment.", "The consultation team recommended suicide precautions and trauma-informed care while it continued evaluating suicidality before spine surgery.", "She conceded that psychosis can fluctuate and that a person may have moments of clarity."], source: "SRC-0078, Trial Day 5, 02:02:12–02:13:31 and 02:18:30–02:19:17", caution: "This was approximately 1.5 days later and was not an offense-time forensic examination.", views: ["post"]
  },
  {
  ...
  },
  {
    ...
    details: ["On January 29, Shah also evaluated safety, medication questions, and Clancy's capacity to change her health-care proxy from Patrick to her parents. Confusion and visual hallucinations led Shah to defer the capacity decision.", "By January 30, the delirium had cleared, Clancy's choice remained consistent, and the proxy change was permitted. Shah documented calm, cooperative, organized and goal-directed behavior, fair insight and judgment, and denials of SI, HI, ongoing hallucinations, and delusions.", "This postoperative delirium occurred days later and does not establish Clancy's mental state on January 24."], source: "SRC-0078, Trial Day 5, 01:28:44–01:40:36", caution: "The capacity finding concerned a specific health-care-proxy decision after delirium cleared; it was not an opinion about criminal responsibility or Clancy's capacity on January 24.", views: ["post"]
  },
  {
  ...
  {
    id: "mack-evaluation", date: "2026-04-10T12:00:00", displayDate: "April 10–12, 2026", title: "Commonwealth forensic evaluation: Mack and Heilbrun", short: "Two joint interviews · intervening psychological testing", category: "post", evidence: "Retained expert opinion", certainty: "Contested", clinician: "Avram Mack, MD; Kirk Heilbrun, PhD", providerLabel: "Forensic evaluators", institution: "Tewksbury Hospital", side: "top", tier: 1,
    ...
    details: ["Mack and Heilbrun jointly interviewed Clancy on April 10 and April 12; Heilbrun conducted psychological testing on April 11.", "April 2026 MMPI response-style scales suggested slight under-reporting and showed no clinical-scale elevations, while suicide/death ideation was elevated. Retrospective Beck and Columbia responses characterized January 2023 as a very serious suicide attempt; current responses and Tewksbury 1:1 precautions supported continuing suicide risk.", "The testing occurred roughly three years after the acts. The MMPI described the April 2026 state, while purported January 2023 administrations depended on retrospective responding; broad testing did not validate one disputed symptom or reconstruct offense-time mental state.", "Mack diagnosed a major depressive episode, probably within major depressive disorder, with possible generalized anxiety; he found no mania, hypomania, postpartum psychosis, or psychosis.", "He agreed that a mental disease or defect was present but opined that Clancy retained both cognitive and volitional capacities, relying on her retrospective wording, organized conduct, day-of interactions, and the absence of a reported command about method.", "Cross-examination concluded August 24. The defense challenged Mack's limited criminal-responsibility trial experience, the nearly three-year delay before evaluation, and aspects of his record interpretation; Mack maintained his diagnostic and capacity opinions."], source: "SRC-0113, Trial Day 18, 01:22:03–03:57:35; SRC-0118/SRC-0132, Trial Day 19, 02:52:15–03:06:13", caution: "These are retained Commonwealth expert opinions and late testing based partly on retrospective statements and record review. Cross-examination tested their foundation but did not itself establish a competing fact.", views: ["post"]
  },
  {
    id: "saathoff-evaluation", date: "2026-05-29T12:00:00", displayDate: "May 29 & Jun. 4", title: "Saathoff forensic evaluation", short: "Two video interviews · approximately 11–11.5 hours", category: "post", evidence: "Retained expert opinion", certainty: "High", clinician: "Gregory Saathoff, MD", providerLabel: "Commonwealth psychiatrist / retained evaluator", institution: "Commonwealth evaluation", side: "bottom", tier: 1,
    summary: "Saathoff interviewed Clancy by video on May 29 and June 4, 2026, more than three years after the acts, and separately interviewed Patrick as part of his retained evaluation.",
    details: ["The first Clancy interview lasted approximately six to six-and-a-half hours; the second lasted about five hours.", "The interviews were retrospective forensic evaluations, not treatment encounters and not contemporaneous observations of her January 2023 condition.", "Saathoff later testified for the Commonwealth on August 25 and 26."], source: "SRC-0119–SRC-0120, Trial Days 20–21", caution: "The interview dates and duration are established by sworn testimony. Diagnostic, credibility, and criminal-responsibility conclusions drawn from them remain expert opinion.", views: ["post"]
  },
  {
    id: "defense-experts-day15-16", date: "2026-08-19T12:00:00", displayDate: "Aug. 18–19", title: "Defense experts: medication, psychosis and capacity", short: "Condie, Laposata and Zeizel · Trial Days 15–16", category: "post", evidence: "Expert testimony", certainty: "Contested", side: "bottom", tier: 2,
  ...
  {
    id: "dueling-psychiatrists-day18", date: "2026-08-21T12:00:00", displayDate: "Aug. 21 & 24", title: "Forensic psychiatrists disagree on criminal responsibility", short: "Resnick for defense · Mack for Commonwealth · Trial Days 18–19", category: "post", evidence: "Expert testimony", certainty: "Contested", side: "top", tier: 0,
    ...
    details: ["Resnick: bipolar II disorder with severe depression; acute postpartum psychosis, command hallucination, and delusion of influence; both cognitive and volitional capacities substantially impaired.", "Mack: major depressive episode, probably major depressive disorder, with possible anxiety; no mania or psychosis; both capacities retained.", "Resnick treated organized behavior as compatible with intermittent psychosis. Mack treated the communications, sequence, stated reasoning, and organized conduct as supporting retained capacities in this case.", "Mack's cross-examination concluded August 24. He acknowledged the long interval between the acts and his interviews and that bipolar II is a serious mental illness, while maintaining that the record did not establish bipolar disorder or psychosis in Clancy."], source: "SRC-0113, Trial Day 18; SRC-0118, Trial Day 19", caution: "These are opposing forensic opinions, not established facts or a verdict. Planning does not exclude psychosis, and psychosis alone does not establish lack of criminal responsibility.", views: ["post"]
  },
  {
    id: "heilbrun-testimony", date: "2026-08-25T12:00:00", displayDate: "Aug. 24–25", title: "Heilbrun: bipolar II, not acute psychosis", short: "Commonwealth forensic psychologist · Trial Days 19–20", category: "post", evidence: "Expert testimony", certainty: "Contested", clinician: "Kirk Heilbrun, PhD", providerLabel: "Commonwealth forensic psychologist", institution: "Commonwealth rebuttal", side: "bottom", tier: 1,
    summary: "Heilbrun accepted bipolar II disorder and a serious mental disease or defect, but interpreted the acts as suicide combined with altruistic filicide rather than conduct caused by an acute psychotic episode.",
    details: ["He attributed the clinical picture to bipolar-II depressive symptoms worsened by sleep problems and probable continuing adverse medication reactions; he did not diagnose postpartum psychosis.", "Clancy retrospectively described an external, unfamiliar male voice—the first and only such episode—as constant for roughly 18–20 minutes, without an associated delusion or reported coping or resistance. Heilbrun identified some features as compatible with a genuine hallucination and others as atypical.", "He described Clancy's reported sense of watching herself as consistent with peritraumatic dissociation, which can resemble psychosis phenomenologically without establishing it.", "Broad testing did not indicate malingering, but Heilbrun emphasized that it could not validate the truth of one specific retrospective symptom.", "He opined that she retained awareness of illegality and moral wrongfulness and retained control over whether, when, and how to act, despite depression, hopelessness, and a serious suicide attempt.", "On cross he agreed that severe insomnia can lead to psychosis, that the reported experience was consistent with peritraumatic dissociation, and that some features could suggest psychosis. He had evaluated Clancy years later and had not listened to the 911 recording.", "After Heilbrun discussed Catholic doctrine, the judge struck that subject, denied a defense mistrial motion, and instructed jurors to disregard it; the stricken material was not evidence."], source: "SRC-0118/SRC-0132, Trial Day 19, 03:10:39–03:30:43; SRC-0119, Trial Day 20", caution: "‘Altruistic filicide,’ bipolar II, peritraumatic dissociation, symptom interpretation, and retained legal capacities are Heilbrun's forensic formulations, not adjudicated facts. Absence of malingering-scale evidence does not authenticate a specific voice account.", views: ["post"]
  },
  {
    id: "saathoff-testimony", date: "2026-08-26T12:00:00", displayDate: "Aug. 25–26", title: "Saathoff: bipolar II with retained capacities", short: "Commonwealth psychiatrist / retained evaluator · Trial Days 20–21", category: "post", evidence: "Expert testimony", certainty: "Contested", clinician: "Gregory Saathoff, MD", providerLabel: "Commonwealth psychiatrist / retained evaluator", institution: "Commonwealth rebuttal", side: "top", tier: 1,
    summary: "Saathoff diagnosed bipolar II disorder and a mental disease or defect, but rejected an offense-time command-psychosis explanation and opined that Clancy remained criminally responsible.",
    details: ["Saathoff interviewed Clancy by video for roughly six to six-and-a-half hours on May 29 and about five hours on June 4, 2026—more than three years after the acts—and separately interviewed Patrick.", "He accepted that the self-harm was a genuine, ‘very, very serious’ suicide attempt; he did not treat that conclusion as resolving diagnosis or criminal responsibility.", "He tied the bipolar-II formulation partly to marked insomnia after sertraline and said he would use the diagnosis to warn future clinicians about SSRI treatment, while acknowledging that the history did not satisfy all or many formal criteria.", "He interpreted the reported relief of intrusive thoughts with lorazepam as supporting internal anxiety-related thoughts rather than an external voice; that remains an expert inference, not a pharmacologic test of phenomenology.", "Saathoff highlighted differing retrospective voice timelines: in his interview, onset was described after the approximately 5:34 p.m. callback near the refrigerator; Spinelli material placed onset around Patrick's 5:10–5:15 departure, increasing in intensity and including a belief that the children would suffer. These are competing retrospective reports, not objective timestamps of a voice.", "On cross he agreed that the reported external quality could be compatible with a genuine hallucination and said a prosecution characterization of Clancy's conduct as a selfish choice, provider manipulation, and a search for a quick fix ‘really minimizes what she was going through’; he did not withdraw his overall opinion.", "He relied on the day-of sequence, route and timing searches, avoidance of witnesses, concealment, and inconsistencies in retrospective accounts to support retained appreciation and behavioral control.", "He testified that psychosis or a command hallucination, even if present, would not automatically determine either legal capacity; he ultimately opined that both capacities were retained."], source: "SRC-0119/SRC-0133, Trial Day 20, 06:50:45–06:54:31; SRC-0120/SRC-0134, Trial Day 21, 00:07:31–00:12:30 and 02:32:05–02:36:03", caution: "Saathoff's diagnosis, interpretation of lorazepam response, credibility analysis, voice-account comparison, concessions, and criminal-responsibility conclusions are retained expert opinions. They do not establish medication ingestion beyond the underlying evidence.", views: ["post"]
  },
  {
    id: "closing-arguments", date: "2026-08-27T12:00:00", displayDate: "August 27, 2026", title: "Closing arguments and jury instructions", short: "Competing theories submitted to jury · deliberations begin", category: "post", evidence: "Attorney argument", certainty: "High", side: "bottom", tier: 2,
    summary: "The parties presented opposing interpretations of the same psychiatric and behavioral record, after which Judge Sullivan instructed the jury on criminal responsibility, homicide offenses, burden of proof, and unanimity.",
    details: ["The defense argued that severe perinatal illness, psychosis, medication effects, and a genuine suicide attempt left Clancy without criminal responsibility.", "The Commonwealth argued that Clancy was depressed but not psychotic, created an opportunity to kill the children, and retained both appreciation and control.", "The judge instructed that the Commonwealth bore the burden beyond a reasonable doubt to prove criminal responsibility, and that lack of responsibility could rest on substantial impairment of either appreciation of wrongfulness or ability to conform conduct.", "Deliberations began after the final charge."], source: "SRC-0121, Trial Day 22", caution: "Closing statements are advocacy, not evidence. Jury instructions state the governing law; the later hung jury did not adopt either side's factual theory.", views: ["post"]
  },
  {
    id: "hung-jury-mistrial", date: "2026-09-04T12:00:00", displayDate: "September 4, 2026", title: "Hung jury; mistrial declared", short: "Seven deliberation days · no verdict on any count", category: "post", evidence: "Judicial proceeding", certainty: "High", side: "top", tier: 0,
    summary: "After seven days of deliberations, the jury reported that it could not reach a unanimous decision. Judge Sullivan declared a mistrial; no verdict was recorded on any count, and there was no conviction, acquittal, or binding finding about criminal responsibility.",
    sequenceTitle: "Deliberation and mistrial sequence",
    sequence: [
      { time: "Aug 27", title: "Deliberations begin", detail: "The jury received final instructions and began considering the charges and criminal-responsibility issue.", evidence: "SRC-0121 · court proceeding" },
      { time: "Aug 28", title: "Physical exhibits requested", detail: "According to counsel and contemporaneous reporting, jurors requested the knife and prescription-bottle evidence. The underlying jury note is not public, and the request does not reveal how jurors evaluated those exhibits.", evidence: "SRC-0122; SRC-0149 · counsel account in AP report" },
      { time: "Sep 1", title: "First reported impasse", detail: "After many hours, jurors said they were unable to reach unanimity; the judge directed them to continue under the existing instructions.", evidence: "SRC-0124 · recorded proceeding" },
      { time: "Sep 2", title: "Tuey–Rodriguez instruction", detail: "After another impasse, the judge delivered Massachusetts's supplemental deadlock instruction and deliberations continued.", evidence: "SRC-0125 · recorded proceeding" },
      { time: "Sep 3", title: "Reasonable-doubt reinstruction", detail: "A foreperson note reported a dispute about one juror's application of reasonable doubt. After sidebar inquiry of all jurors, the judge said each affirmed following the law, re-instructed the jury, and declined a defense request to remove the juror or conduct further inquiry.", evidence: "SRC-0126 · recorded proceeding" },
      { time: "Sep 4", title: "Final note, SJC petition, mistrial", detail: "The jury reported it would not reach unanimity. The defense unsuccessfully sought emergency SJC intervention and requested polling on lesser offenses; the trial judge then discharged the jury and declared a mistrial.", evidence: "SRC-0127–SRC-0128 · proceeding and petition" },
    ],
    details: ["The jury was not publicly polled on its vote or on lesser offenses. Claims about an exact numerical split or the direction of votes therefore are not a verdict and should not be treated as an adjudicated finding.", "The charges remain pending. As of this final update, the Commonwealth had not announced whether it would retry the case.", "The matter was continued to September 29, 2026 at 9:00 a.m. for status, trial assignment, and argument on a Rule 25 motion; that prospective hearing falls outside this final-trial evidence cutoff."], source: "SRC-0122–SRC-0128; SRC-0131; SRC-0149", caution: "A mistrial ends this jury trial without deciding the merits. It does not establish guilt, acquittal, psychosis, or lack of criminal responsibility.", views: ["post"]
  },
];
...
const additionalCourseEvents: TimelineEvent[] = [
  ...
  },
  {
    ...
    details: ["She wrote that she felt sad or depressed, had stopped breastfeeding, and felt less connected to Callan than she had hoped.", "She described some resentment toward the older children, immediately recognized that it was unfair, and wrote that she wanted love and connection with all three children.", "She wrote that she had wanted a fourth child but needed ‘a really good therapist,’ and that she wanted to feel ‘authentically happy and not fake.’", "She described having felt depressed and unable to enjoy the children the previous evening, and called her inability to parent each child as she had parented her first the ‘root cause of all our problems.’", "The note also contained goal-directed plans and affirmations, including plans for therapy and activities and statements that she would overcome postpartum anxiety and depression, was a great mom, and loved her children.", "She wanted eight hours of sleep, therapy, and to feel happy and relaxed; she wrote that she felt traumatized only when ‘severely sleep-deprived and paranoid.’", "She feared that something could happen to the children or that mistakes could harm their development.", "The extraction could not identify what changed on November 3; the modification could have involved one character or the entire note."],
    source: "SRC-0099, Trial Day 13, pp. 23–26, 01:49:04–01:56:10; SRC-0102, Boston.com Day 14 report of the displayed note", caution: "This is contemporaneous self-report, not a clinician assessment. ‘Paranoid’ is Clancy's own word in a private note and does not by itself establish delusional paranoia or psychosis.", views: ["course"]
  },
  {
    id: "phone-note-dec22", date: "2022-12-22T12:00:00", displayDate: "December 22 / Jan. 23", title: "Phone note: ‘Medication stole my motherhood and my life’", short: "Created Dec. 22 · last modified Jan. 23", category: "digital", evidence: "Mixed evidence", certainty: "Moderate", side: "bottom", tier: 1,
    summary: "A second note extracted from Clancy's phone, created December 22 and last modified January 23, presented her own account of symptom onset, insomnia she attributed to sertraline, subsequent sedative use, and perceived medication-related decline.",
    details: ["The note began, ‘Medication stole my motherhood and my life,’ and described Clancy as previously the ‘healthiest, happiest mom’ who exercised, meditated, and tried to care for herself so she could be at her best for the children.", "She wrote that the sequence began with ‘a touch of postpartum anxiety’ involving Callan's bottle refusal, a strict sleep schedule, her anticipated return to work, and caring for three young children.", "The note said that she asked a psychiatrist for Zoloft (sertraline), increased the dose according to the doctor's instructions, and then ‘couldn't sleep a wink.’ The published report did not reproduce the exact dose values or duration stated in the note; those details remain separately documented and contested in the clinical/pharmacy evidence.", "She wrote that she was told to stop sertraline and use Ativan (lorazepam) and Benadryl (diphenhydramine) for sleep, later felt ‘dependent’ on medication to sleep, and viewed this as when everything started ‘going downhill.’", "The forensic examiner established the December 22 creation date and a January 23, 10:23 a.m. last-modified timestamp, but could not determine how many edits occurred or what changed. On Day 14, Ian Whiffin testified that only approximately two-sentence snippets of earlier versions were recoverable; the December 22 snippet began the same way and the visible differences were largely spelling-related. That limited recovery does not establish that every part of the complete note remained unchanged."],
    source: "SRC-0099, Trial Day 13, pp. 26–27, 01:56:14–01:57:17; SRC-0101, Trial Day 14, 00:34:37–00:35:32 and 01:04:51–01:06:09; SRC-0102, Boston.com Day 14 report; SRC-0168, CNN Aug. 13 same-day exhibit report", caution: "This is a contemporaneous note extracted from Clancy's phone and attributed to her at trial. It records her own retrospective account and causal interpretation; it is not a medication-administration record or independent proof of exact dosing, adherence, pharmacologic causation, diagnosis, psychosis, or criminal responsibility. The complete native note and edit history are not publicly available.", views: ["course"]
  },
  {
  ...
  {
    id: "phone-search-jan19", date: "2023-01-10T10:00:00", displayDate: "January 10–20", title: "Phone searches: medications, sleep, ketamine, and psychosis", short: "Extracted search artifacts · not symptoms or diagnoses", category: "digital", evidence: "Objective record", certainty: "High", side: "top", tier: 2,
    summary: "The phone extraction recorded a series of mental-health and medication-related searches from January 10 through January 20, including drug interactions, sleep deprivation, ketamine, psychosis, benzodiazepine withdrawal, and a sociopathy query.",
    details: ["January 10: trazodone, Benadryl, and medication/analgesic-interaction searches.", "January 12: Wellbutrin (bupropion), Lamictal (lamotrigine), Elavil (amitriptyline), and sleep-deprivation searches.", "January 18: ‘ketamine for suicidal ideation.’", "January 19: symptoms of postpartum psychosis, schizophrenia at 9:58 a.m., hallucinations at 10:33 a.m., and a ‘psychosis symptoms’ search.", "January 20: ‘benzo withdrawals’ at 8:11 p.m.; ‘can you treat a sociopath?’ at 8:28 p.m.; and psychosis/ketamine artifacts around 8:39 p.m.", "One January 20 query referred to being ‘on Seroquel’ and feeling unable to have a conversation; an ‘intrusive’ artifact was also shown, but its full query was not established.", "The examiner recovered more than 1,300 web records for early January through January 24, performed only a cursory relevance review, and displayed selected items. The larger set also contained ordinary parenting, child-health, and activity searches.", "A single search may appear in multiple forensic-tool categories, so repeated rows are not necessarily separate user actions."],
    source: "SRC-0099, Trial Day 13, pp. 22–23 and 45–55, 01:46:45–01:48:56, 03:33:20–03:56:33, and 04:50:29–04:53:16; SRC-0101, Trial Day 14, 00:27:30–00:33:32 and 01:02:49–01:04:50", caution: "The displayed mental-health queries were an examiner-selected subset of a much larger browsing record. Searches can reflect distress, curiosity, self-assessment, medication concerns, or many other motives; they do not establish that the searched condition was present or that any named drug was prescribed or taken.", views: ["course"]
  },
  {
    id: "phone-media-jan23", date: "2023-01-23T20:00:00", displayDate: "January 23", title: "Phone media: children's Live Photos converted to stills", short: "Access/modification artifacts · user and purpose unresolved", category: "digital", evidence: "Objective record", certainty: "Contested", side: "top", tier: 3,
    summary: "The phone extraction showed access or modification timestamps for photographs of the children on January 23; the only identified technical change was conversion of Live Photos to still images.",
    details: ["The forensic examiner could identify the Live-Photo-to-still conversion but could not determine from the artifacts who handled the phone or why the images were accessed or changed.", "The timestamps do not establish that images were deleted, edited for content, viewed by Clancy, or connected to her mental state or later conduct."],
    source: "SRC-0099, Trial Day 13, pp. 27–29, 01:57:18–02:02:21 and 03:53:09–03:54:32", caution: "This is device activity with unresolved user and purpose. It should not be converted into evidence of intent, planning, farewell behavior, diagnosis, or criminal responsibility.", views: ["course"]
  },
  {
    ...
    summary: "Clancy completed intake materials three days before her first Tufts evaluation.", details: ["The forms preceded the September 15 clinical assessment.", "Later testimony described anxiety, depressive symptoms, insomnia, and racing thoughts, with negative suicide, harm, voice, and psychosis items.", "The forms recorded anxiety from September 2013 to September 2014 and postpartum anxiety beginning in May 2020; Prozac (fluoxetine) 50 mg and Wellbutrin (bupropion) 100 mg were marked effective without side effects.", "Paul later elicited a partly different retrospective history of prior benefit from fluoxetine, propranolol, and bupropion, with sexual side effects, and postpartum anxiety after the second child managed without medication. The two histories should not be silently merged."], source: "SRC-0087, Trial Day 9, 03:38:39–04:06:46; SRC-0091, Trial Day 10, pp. 74 and 96–97, 05:30:09–05:31:57 and 06:28:02–06:29:46", caution: "The forms and the clinician encounter occurred on different dates. Prior diagnoses, treatment effects, and side effects are historical reports rather than independently verified medication-administration records.", views: ["course"]
  },
  {
    ...
    summary: "Tufts prescribed sertraline 25 mg daily for one week, then 50 mg; the pharmacy exhibit records a same-day 25 mg quantity-30 fill.", details: ["Indication was anxiety/depressive symptoms.", "Clancy later reported that she did not begin the medication on this date.", "A later CVS bottle exhibit reportedly contained 23 of the 30 tablets. Seven missing 25-mg tablets do not reconcile with seven days at 25 mg plus even one 50-mg dose, which would require at least nine tablets."], medication: "Zoloft (sertraline) 25 mg prescribed/filled; 50 mg planned", source: "SRC-0087, 04:03:55–04:06:46; SRC-0048, Sept. 15 row; SRC-0108, Trial Day 16, 00:55:20–00:58:04", caution: "Prescription, dispensing, and a later pill count do not establish ingestion, who removed tablets, loss, or whether medication came from any other supply. The patient-reported 50-mg exposure remains clinically relevant but is not reconciled by the available CVS count.", views: ["course"]
  },
  {
  ...
  {
    id: "oct10-leave-message", date: "2022-10-10T12:00:00", displayDate: "October 10", title: "MyChart message: work-leave form corrected", short: "Clancy says discussed leave ran through January 1", category: "symptom", evidence: "Contemporaneous record", certainty: "High", clinician: "Jennifer Tufts, MD", institution: "Aster Mental Health", side: "top", tier: 2,
    summary: "Clancy messaged Tufts that their discussed leave was supposed to run through January 1 but the completed form appeared to permit an immediate return to work.", details: ["She asked that the paperwork be corrected, and Tufts replied that she would return an updated form.", "The exchange documents continuing functional limitation and leave planning; it is not a new mental-status examination."], source: "SRC-0087, Trial Day 9, PDF pp. 102–103, 05:45:21–05:46:36", caution: "A work-leave request documents perceived functional impairment and the treatment plan, but does not by itself establish symptom severity on that date.", views: ["course"]
  },
  {
    ...
    summary: "Tufts advised Clancy to stop sertraline after the adverse-symptom report. Clancy did not want to start another prescription medication immediately.", details: ["Tufts discussed possible alternatives and natural supplements because Clancy was reluctant to begin another prescription.", "The exact sertraline start date and number of doses remain uncertain.", "Later history to Jollotta described roughly 48 hours without sleep and without fatigue; Jollotta called that an activating response.", "A later CVS bottle count—23 of 30 tablets remaining—does not reconcile with the reported seven days at 25 mg followed by a 50-mg dose. The count neither disproves her report nor proves ingestion."], medication: "Zoloft (sertraline) stopped; replacement prescription deferred", source: "SRC-0087, Trial Day 9, pp. 105–109, 05:52:52–06:00:08; SRC-0091, Trial Day 10, pp. 42–45; SRC-0096, Trial Day 11, pp. 46–50; SRC-0108, Trial Day 16, 00:55:20–00:58:04", caution: "Temporal association supports concern but does not prove a bipolar switch or medication causation. The available dispensing and pill-count evidence does not establish the reported dose sequence.", views: ["course"]
  },
  {
  ...
  {
    id: "diary-nov18", date: "2022-11-18T18:00:00", displayDate: "November 18", title: "Diary entry: desperate for a mental break", short: "Contemporaneous writing reported from admitted exhibit", category: "digital", evidence: "Secondary exhibit reporting", certainty: "Moderate", side: "top", tier: 2,
    summary: "The Associated Press reported that an admitted November 18 diary entry said Clancy was ‘so desperate to get a mental break from taking care of everyone’ that her mind was trying to find something physically wrong with her.", details: ["The same reporting described undated writings about brain fog, infant nap schedules, and guilt over stopping breastfeeding.", "The original journal pages are not publicly available, so the exact exhibit wording, surrounding entries, authorship foundation, and context cannot be independently inspected in the corpus."], source: "SRC-0077, Associated Press Day 5 report of the admitted diary evidence; underlying journal pages unavailable (MISS-0051)", caution: "The AP account is not a substitute for the original journal, and the undated passages should not be assigned to November 18.", views: ["course"]
  },
  {
  ...
  },
  {
    ...
    summary: "At a patient-self-scheduled Tufts video appointment, Clancy denied active suicidal ideation but described fear of getting close to suicidal thoughts and said she was not improving.", details: ["She reviewed recent sleep-medication trials and side effects as she understood them, including trazodone doses from 50 to 150 mg with minimal effect; the exact dates and dose-by-dose exposure were not established.", "Clancy said, ‘I think that's my problem, I keep reaching out to different people and not sticking with the plan.’ Tufts advised using one medication manager.", "Lamotrigine was discussed but not prescribed that day.", "She reported having started mirtazapine and was uncertain whether quetiapine had begun."], source: "SRC-0087, Trial Day 9, pp. 114–119, 06:19:11–06:31:40; SRC-0091, Trial Day 10, pp. 53–54, approximately 03:26:37–03:27:16", caution: "The medication history was Clancy's self-report during this Tufts video encounter. Reported trazodone dose range does not fix prescription, ingestion, or timing for each dose.", views: ["course"]
  },
  {
  ...
  },
  {
    ...
    summary: "Clancy told Dukes that a difficult weekend of continuous intrusive thoughts of wanting to die or not be present led to a virtual Aspire crisis evaluation; at the December 5 follow-up, she denied current suicidal ideation.", details: ["Clancy reported that Aspire found she did not meet inpatient criteria because she lacked a suicide plan and recommended a day program; Dukes recorded that account in a December 8 note later read into testimony.", "Dukes did not observe psychosis, mania, homicidal ideation, delusions, or paranoia and did not assess an immediate crisis during this visit.", "Patrick joined the video visit. Dukes recommended IOP/PHP-level care and reviewed sleep hygiene; Clancy was interested rather than declining.", "Clancy requested psychological testing for additional diagnostic and medication input."], civilClaims: [{ claim: "The complaint labels a weekend crisis contact a New Bedford Suicide Hotline call prompted by hallucinations.", source: "SRC-0032 ¶45", context: "Dukes directly testified only to Clancy's report of a virtual Aspire evaluation after continuous suicidal thoughts. The underlying Aspire record, exact service identity, and alleged hallucination content remain unavailable." }], source: "SRC-0098, Trial Day 12, 02:14:00–02:23:15; cross 03:23:49–03:25:55; SRC-0120/SRC-0134, Trial Day 21, 03:03:43–03:06:23; compare SRC-0032 ¶45", caution: "Aspire's reported disposition is supported by a contemporaneous Dukes note, but still entered through Clancy's report rather than an Aspire evaluator or the underlying crisis record; a refusal-of-care characterization is unsupported.", views: ["course"]
  },
  {
    id: "surface-search-dec5", date: "2022-12-05T16:00:00", displayDate: "December 5 and later", title: "Shared-device searches: prescribing, medications, bipolarity, and DBT", short: "Surface Pro artifacts · human user unresolved", category: "digital", evidence: "Objective record", certainty: "Contested", side: "bottom", tier: 3,
    summary: "The shared Surface Pro recorded a December 5 search about psychiatric overprescribing and additional report entries concerning lamotrigine, bipolar disorder, benzodiazepines, detoxification, DBT, and mania.", details: ["The December 5 query was ‘what to do when a psychiatrist overprescribed.’ Additional representative entries in the Surface Pro report included Lamictal, ‘can bipolar disorder be temporary,’ ‘can benzos reveal bipolar disorder,’ ‘how long are detox programs,’ ‘what is DBT,’ ‘Lamictal versus Zoloft,’ and ‘what is mania’; the testimony excerpt did not restate a date for each additional item.", "The computer belonged to Patrick and its default browser profile displayed his email address, but the forensic artifacts did not identify the human user. The searches therefore cannot be attributed to either Patrick or Lindsay as established fact."], source: "SRC-0099, Trial Day 13, cross-examination at 01:19:48–01:20:52", caution: "The artifacts establish shared-device activity, not who searched, what pages were read, why the searches occurred, medication exposure, diagnosis, or mental state. Only the overprescribing query is specifically dated December 5 in the cited testimony excerpt.", views: ["course"]
  },
  {
  ...
  },
  {
    ...
    summary: "Clancy reported taking diazepam and quetiapine, sleeping about 9 p.m. to 5 a.m. with awakenings, then experiencing panic and asking for a slower diazepam taper.", details: ["The message did not specify the doses used.", "A separate, undated kitchen log introduced at trial and identified by Patrick included an entry read approximately as ‘5 mg Valium, 200 [mg] Seroquel, slept well, horrible thoughts in the morning.’ Its exact date and authorship were not fixed in the excerpt."], medication: "Diazepam + quetiapine reportedly taken; doses unspecified", source: "SRC-0096, Day 11 PDF p. 54, 3:17:06–3:18:45; SRC-0068, Trial Day 2, 01:46:32–01:47:24", caution: "The proposed titration schedule does not establish the dose actually taken. The kitchen-log entry is contemporaneous physical evidence but cannot be assigned to December 8 or used as a complete administration record.", views: ["course"]
  },
  {
  ...
  },
  {
    ...
    summary: "Clancy went to the MGH emergency department after the December 15 higher-level-of-care discussion; the available testimony does not describe a single, unanimous disposition recommendation.", details: ["Patrick recalled that one clinician favored or offered inpatient McLean care while two clinicians favored a day-program pathway through Women & Infants.", "Condie and Zeizel, testifying later from records they had reviewed, each agreed on cross that inpatient McLean care was recommended or offered and was not accepted during this encounter.", "Clancy and Patrick then pursued outpatient Women & Infants follow-up, which occurred on December 20—not December 15."], source: "SRC-0096, pp. 63–67; SRC-0065, Trial Day 1, 02:12:47–02:14:52; SRC-0105, Trial Day 15, 01:55:13–01:56:16; SRC-0108, Trial Day 16, 01:09:59–01:11:24", caution: "The complete MGH chart is not publicly available. Patrick's recollection and later expert summaries differ in emphasis; the chart would control the exact recommendations, options, and disposition.", views: ["course"]
  },
  {
    ...
    summary: "Tufts prescribed and the pharmacy dispensed lamotrigine 25 mg quantity 30.", details: ["Jollotta later endorsed the plan and counseled about rash and slow titration.", "Saathoff testified that Clancy told him in 2026 that Susan's physician acquaintance Rose had informally suggested Lamictal outside a doctor–patient relationship; Tufts and Jollotta then discussed or recommended it through their own care channels.", "Jollotta testified that she did not know whether Clancy took it.", "Saathoff also testified that Clancy told him in 2026 that she chose not to take lamotrigine because of concern about a serious rash. That retrospective report coexists with later toxicologic detection and does not resolve routine or event-day exposure."], medication: "Lamictal (lamotrigine) 25 mg ×30 prescribed/filled", source: "SRC-0087, 06:31:40–06:37:05; SRC-0048; SRC-0096, pp. 66–69; SRC-0119/SRC-0133, Trial Day 20, 07:10:59–07:17:33", caution: "The Rose discussion and nonadherence account are retrospective patient reports relayed by a retained expert, not an additional clinical encounter or administration record. Prescription, fill, cross-provider endorsement, retrospective nonadherence, and later detection are distinct evidence; none alone establishes a regular dosing history.", views: ["course"]
  },
  {
...
const medications: Medication[] = [
  { name: "Zoloft", generic: "sertraline", color: "#e77bff", className: "SSRI", summary: "First SSRI; filled in September, started later, and stopped after sleep/anxiety worsening.", segments: [
    ...
    { start: "2022-10-13", end: "2022-10-20", label: "50 mg", status: "reported", note: "Reported increase to 50 mg before discontinuation; exact dates and adherence remain uncertain. A later CVS count of seven missing 25-mg tablets does not reconcile with the reported titration and cannot establish ingestion." },
  ]},
  { name: "Ativan", generic: "lorazepam", color: "#ff8eac", className: "benzodiazepine", summary: "Short-term PRN anxiety/sleep medication; taper attempted; later used at McLean discharge.", segments: [
    ...
    { start: "2022-11-02", end: "2022-11-16", label: "0.75 mg", status: "planned", note: "The documented taper called for 0.75 mg for two weeks after 1 mg. A 0.5-mg ×40 fill supplied tablets, but actual dose and frequency are unresolved." },
    { start: "2022-11-16", end: "2022-12-05", label: "0.5 mg", status: "planned", note: "The next planned taper step was 0.5 mg for two weeks. By November 22 Tufts knew Clancy remained on lorazepam but did not document the exact dose; exposure was not continuously confirmed." },
  ...
  { name: "Lamictal", generic: "lamotrigine", color: "#8ce99a", className: "mood stabilizer / anticonvulsant", summary: "Prescribed and filled at 25 mg; regular use is not documented, but later exposure was detected.", segments: [
    { start: "2022-12-16", end: "2023-01-24", label: "25 mg", status: "prescribed", note: "Tufts prescribed and the pharmacy filled 25 mg; Jollotta did not know whether it was taken, and Clancy told Saathoff years later that she avoided it because of rash concern." },
...
const postBreaks = [
  ...
  { earlyEnd: "2026-06-10T00:00:00", lateStart: "2026-08-17T00:00:00", breakStartPct: 77, breakEndPct: 81, label: "~2 months omitted" },
];
...
const postSegments = [
  ...
  { start: postBreaks[1].lateStart, end: postBreaks[2].earlyEnd, startPct: postBreaks[1].breakEndPct, endPct: postBreaks[2].breakStartPct },
  { start: postBreaks[2].lateStart, end: views.post.end, startPct: postBreaks[2].breakEndPct, endPct: 100 },
];
...
export default function Home() {
  ...
  const postSegmentStartLabels = ["", "May 2024", "Apr 2026", "Aug 2026"];
  const postTicks = postSegments.flatMap((segment, index) => [
    ...(index > 0 ? [{ date: segment.start, label: postSegmentStartLabels[index] }] : []),
    ...(index >= 2 ? [] : monthTicks(segment.start, segment.end)),
  ])
    .filter((tick, index, items) => items.findIndex((candidate) => candidate.date === tick.date) === index)
    .filter((tick) => stamp(views.post.end) - stamp(tick.date) >= 10 * 24 * 60 * 60 * 1000);
  ...
  return (
    <main className="app-shell">
      <header className="topbar" data-presentation-anchor="top">
        ...
        <div className="cutoff"><span>Most recent update</span><strong>Sep 8, 2026 · Final evidence audit</strong><p className="header-credit">Evidence through the September 4 mistrial · Feedback: AKrawec@mednet.ucla.edu</p></div>
      </header>
        ...
        <div className="argument-grid">
          <article className="defense-argument">
            ...
            <div className="argument-evidence">
              <strong>Evidence presented at trial:</strong>
              <ul>
          ...
          <article className="prosecution-argument">
            ...
            <div className="argument-evidence">
              ...
              <ul>
                ...
                <li>Mack, Heilbrun, and Saathoff each opined that Clancy retained criminal responsibility, despite differing diagnostic formulations</li>
              </ul>
            </div>
          </article>
          <div className="argument-boundary">
            ...
            <ul>
              ...
              <li>A hung jury is not a verdict and resolves neither guilt nor criminal responsibility.</li>
            </ul>
          </div>
        </div>
      </section>
      ...
      <section className="common-questions" aria-labelledby="common-questions-title" data-presentation-anchor="common-questions">
        <div className="faq-intro">
          ...
          <p>Concise answers grounded in evidence presented through the September 4, 2026 mistrial. Where the underlying primary record is unavailable, the answer says so.</p>
        </div>
      ...
      <footer data-presentation-anchor="footer">
        ...
        <p>Source IDs correspond to the final-trial corpus through the September 4, 2026 mistrial.</p>
      </footer>
          ...
          <aside key={selectedEvent ? selectedEvent.id : `med-${selectedMedication?.generic}`} className="detail-drawer" data-presentation-drawer role="dialog" aria-modal="true" aria-label={"title" in selected ? selected.title : `${selected.name} medication details`}>
            ...
            {"title" in selected ? (
              <>
                ...
                {selected.sequence && <div className="drawer-section sequence-section"><h3>{selected.sequenceTitle ?? "January 24 timeline"}</h3><div className="sequence-list">{selected.sequence.map((step) => <article key={`${step.time}-${step.title}`}><time>{step.time}</time><div><strong>{step.title}</strong><p>{step.detail}</p><small>{step.evidence}</small></div></article>)}</div></div>}
